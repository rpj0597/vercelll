...
const Dashboard = ({ activeTab, children }) => {
    ...
    return (
        <>
            <main className="flex min-h-screen mt-14  justify-between sm:min-w-full">

                {!onMobile && <Sidebar activeTab={activeTab} />}
                {toggleSidebar && <Sidebar activeTab={activeTab} setToggleSidebar={setToggleSidebar}/>}

                <div className="w-full sm:w-4/5 sm:ml-[300px] min-h-screen">
                    <div className="flex flex-col gap-10 sm:m-8 p-2 pb-6 overflow-hidden">
