...
const Payment = () => {
    ...
    const client_secret="sk_test_51MT0WwSHCKBExyty2eO7HYVjObuMqVwvA3Pl30NkJbwJoXDDTrIIp7836f03XleeU2SkjTPK4be1vwKmOPtyYbbS00PxtIfIWB"
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const result = await stripe.confirmCardPayment(`sk_test_51MT0WwSHCKBExyty2eO7HYVjObuMqVwvA3Pl30NkJbwJoXDDTrIIp7836f03XleeU2SkjTPK4be1vwKmOPtyYbbS00PxtIfIWB`, {
                payment_method: {
    ...
    return (
        <>
            <MetaData title="valentinesaga: Secure Payment | stripe" />
                    ...
                    <div className="flex-1">
                        ...
                        <Stepper activeStep={3}>
                            <div className="w-full bg-white">
                                ...
                                <input ref={paymentBtn} type="submit" value="Pay with Stripe" className="bg-primary-orange w-full sm:w-1/3 my-2 py-3.5 text-sm font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none cursor-pointer" />
                            </form>
                                {/* stripe form */}
