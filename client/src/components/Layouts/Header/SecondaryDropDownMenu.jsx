    ...
    const navs = [
        {
            ...
            redirect: "https://www.valentinesaga.com/communication-preferences/push",
        },
        {
            title: "Sell on valentinesaga",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.valentinesaga.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.valentinesaga.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.valentinesaga.com/mobile-apps",
        },
    ]
