                            ...
                            <div className="flex-1 overflow-hidden shadow bg-white">
                                ...
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    ...
                                    <div className="flex flex-col gap-4 mt-4">
                                        ...
                                        <h4 className="text-sm font-medium">When will my valentinesaga account be updated with the new email address (or mobile number)?</h4>
                                        ...
                                        <h4 className="text-sm font-medium">What happens to my existing valentinesaga account when I update my email address (or mobile number)?</h4>
                                        ...
                                        <p className="text-sm">valentinesaga has a 'single sign-on' policy. Any changes will reflect in your Seller account also.</p>
