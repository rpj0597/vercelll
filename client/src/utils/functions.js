...
export const getProductsByCategory = (prodsArray, category, n) => {
    const filteredProducts = prodsArray.filter((product) => product.category === category);
    const randomProducts = filteredProducts.sort(() => 0.5 - Math.random()).slice(0, n);
